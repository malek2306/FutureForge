...
public class DatabaseHelper {
    ...
    public static int getReclamations(java.sql.Date date) {
        int count = 0;
        try {
            String sql = "SELECT COUNT(*) FROM reclamation where DateR=?";
    ...
    public static int getMessages(java.sql.Date date) {
        int count = 0;
        try {
