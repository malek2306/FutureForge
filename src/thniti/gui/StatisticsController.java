...
import thniti.animations.Animations;
import thniti.utils.*;
...
public class StatisticsController implements Initializable {
    ...
    private void setGraphics() {
        datepicker.setOnAction(ev -> {
            ...
            int count = DatabaseHelper.getReclamations(date);
            int count3 = DatabaseHelper.getMessages(date);
            ...
            if (count == 0  && count3 == 0) {
                ...
                PieChart.Data one = new PieChart.Data("Total Reclamations by date: " + count, count);
                data.add(one);
                ...
                PieChart.Data three = new PieChart.Data("Total messages: " + count3, count3);
                data.add(three);
                pieChart.setData(data);
