...
public class OffreService {
    ...
    public boolean add(Offre offre) {
        String request = "INSERT INTO `offre`(`image_vehicule`, `prenom_chauff`, `num_chauff`, `date_offre`, `heure`, `prix_offre`, `depart`, `destination`, `places_dispo`, `id_etudiant`) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        try {
